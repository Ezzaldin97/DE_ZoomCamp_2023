...
df = spark.read.option("header", "true").parquet("gs://dtc_data_lake_nyc-taxi-pipeline/staging_area/green_tripdata_2019-04.parquet")
...
merged_df.repartition(4).write.parquet("gs://dtc_data_lake_nyc-taxi-pipeline/processed/trip_loc_dist/green_201904")